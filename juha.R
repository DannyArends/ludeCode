...
myvector <- cbind(translation[sortR,c(1,9)],Zscores)
...
resultvector <- cbind(myvector[sortT,c(2,3)], ivector[,c(1,4)])

plot(resultvector[,c(2,4)], pch=19, cex=0.4)
cor(resultvector[,c(2,4)],method="spearman")
